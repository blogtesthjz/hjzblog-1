...
class RouteCollectionBuilderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testFlushSetsPrefixedWithMultipleLevels()
    {
        ...
        $adminRoutes->mount('/blogContent', $adminBlogRoutes);

        // now mount the /admin routes, above should all still be /blogContent/admin
        ...
        $this->assertEquals('/admin/blogContent/new', $collection->get('admin_blog_new')->getPath(), 'Sub-collections receive prefix even if mounted before parent prefix');
