...
class UrlGeneratorTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGenerateRelativePath()
    {
        ...
        $routes->add('scheme', new Route('/{author}/blogContent', array(), array(), array(), '', array('https')));
        ...
        $this->assertSame('https://example.com/app.php/bernhard/blogContent', $generator->generate('scheme',
